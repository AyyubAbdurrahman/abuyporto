            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="text-center z-10">
                    ...
                    <div className="space-x-4 pointer-events-auto">
                        <button className="bg-sky-500 hover:bg-sky-600 text-white px-8 py-3 rounded-lg transition-colors">
                            View Projects
                        </button>
                        <button className="border border-sky-500 text-sky-400 hover:bg-sky-500 hover:text-white px-8 py-3 rounded-lg transition-colors">
                            Contact Me
                        </button>
                    </div>
                </div>
