...
export default function ProjectCard({ project }) {
    return (
        <div className="bg-slate-800 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow group">
            <div className="relative overflow-hidden">
                ...
                {project.is_featured && (
                    <div className="absolute top-4 right-4">
                        <span className="bg-yellow-500/80 text-yellow-100 px-2 py-1 text-xs font-medium rounded-full">
                            Featured
                        </span>
                    </div>
                )}
                ...
                {project.technologies && (
                    <div className="flex flex-wrap gap-2 mb-4">
                        {project.technologies.slice(0, 3).map((tech, index) => (
                            <span
                                key={index}
                                className="bg-slate-700 text-slate-300 px-2 py-1 text-xs rounded"
                            >
                                {tech}
                            </span>
                        ))}
